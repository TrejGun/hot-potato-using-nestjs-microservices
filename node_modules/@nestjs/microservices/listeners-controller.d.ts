...
export declare class ListenersController {
    ...
    createRequestScopedHandler(wrapper: InstanceWrapper, pattern: PatternMetadata, moduleRef: Module, moduleKey: string, methodKey: string, defaultCallMetadata?: Record<string, any>): (...args: unknown[]) => Promise<any>;
