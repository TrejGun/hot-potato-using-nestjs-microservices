...
import { HealthIndicatorFunction, HealthIndicatorResult } from '../health-indicator';
...
export declare class HealthCheckExecutor implements BeforeApplicationShutdown {
     ...
     */
    executeDeprecated(healthIndicators: HealthIndicatorFunction[]): Promise<HealthIndicatorResult>;
    /**
     * Executes the given health indicators.
     * Implementation for v6 compatibility.
     *
